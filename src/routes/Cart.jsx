...
const Cart = ({ cart, setCart }) => {
  ...
  return (
    <>
      <div className="bg-stone-100 dark:bg-gray-800 dark:text-white pb-20 duration-200 h-[87vh] sm:h-[93vh]">
        ...
        <div className="w-full md:w-2/3 mx-auto p-6">
          ...
          <div className="flex flex-col sm:flex-row justify-between text-xl xl:text-2xl font-bold">
            ...
            <Link
              to="/payment"
              className="bg-[#87CEEB] dark:bg-[#001F3F] text-center rounded-full px-2 font-medium"
            >
              Payment
            </Link>
          </div>
